...
class Optimizer_AdaGrad:
    ...
    def update_params(self, layer):
        ...
        # apply updates
        layer.weights -= self.current_learning_rate * layer.dweights / (np.sqrt(layer.bias_cache) + self.epsilon)
...
class Optimizer_Adam:
    ...
    def update_params(self, layer):
        ...
        # update momentum w. current gradients
        layer.weight_momentums = self.beta_1 * layer.weight_momentums + (1 - self.beta_1) * layer.dweights
        layer.bias_momentums = self.beta_1 * layer.bias_momentums + (1 - self.beta_1) * layer.dbiases

        # get corrected momentums
        weight_momentums_corrected = layer.weight_momentums / (1.0 - self.beta_1 ** (self.iterations + 1))
        ...
        # get corrected cache
        weight_cache_corrected = layer.weight_cache / (1.0 - self.beta_2 ** (self.iterations + 1))
        bias_cache_corrected = layer.bias_cache / (1.0 - self.beta_2 ** (self.iterations + 1))

        # regular stochastic gradient descent parameter update plus normalization
